# Generated by Powerlevel10k configuration wizard on 2024-04-20 at 18:05 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    context                 # user@hostname (SSH時のみ表示)
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # context               # user@hostname (左プロンプトに移動済み)
  ...
  # Context color in SSH without privileges: オレンジで目立たせる
  ...
  # Context format when in SSH without privileges: アイコン付きで目立つ表示
